...
processAll <- function() {
    ...
    figDirnamePattern <- "videos/%s/cosPhasesElec%03d-%03dFPS%.02fFrom%03dTo%03dHtFilteredFrom%.02fTo%0.2fOrder%02dZScored%d"
    figFilenamePattern <- "cosPhaseIndex%06d.png"

    toTime <- fromTime + duration
    saveCosPhaseImagesGGPlot2(sessionLabel=sessionLabel,
