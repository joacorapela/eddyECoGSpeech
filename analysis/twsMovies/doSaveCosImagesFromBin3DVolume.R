...
processAll <- function() {
    ...
    figDirnamePattern <- "videos/%s/cos3DUnwrappedPhasesElec%03d-%03dFPS%.02fFrom%03dTo%03dHtFilteredFrom%.02fTo%0.2fOrder%02dZScored%d"
    figFilenamePattern <- "cos3DUnwrappedPhaseIndex%06d.png"
...
#     saveImagesFromDatacube(datacube=scaledPhasesDatacubeToSave,
    saveImagesFromDatacube(datacube=cos(phasesDatacubeToSave),
