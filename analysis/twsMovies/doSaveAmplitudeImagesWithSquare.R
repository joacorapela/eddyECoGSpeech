...
#     fromTime <- 130
    ...
    figDirnamePattern <- "videos/%s/amplitudes%.02ffpsFromTime%03dTo%03dHtFilteredFrom%.02fTo%0.2fOrder%02d_squareXMin%02dXMax%02dYMin%02dYMax%02d"
    figFilenamePattern <- "amplitudesIndex%06d.png"

    toTime <- fromTime + duration
    saveAmplitudeImagesWithSquare(sessionLabel=sessionLabel,
