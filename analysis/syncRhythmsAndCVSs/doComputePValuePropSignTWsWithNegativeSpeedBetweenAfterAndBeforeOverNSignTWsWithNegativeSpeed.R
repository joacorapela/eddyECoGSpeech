...
processAll <- function() {
    ...
    resultsFilenamePattern <-
     "results/%s/pValuePropSignTWsWithNegativeSpeedBetweenBeforeAndAfterOverNSignTWsWithNegativeSpeed.RData"
    figFilenamePattern <-
     "figures/%s/pValuePropSignTWsWithNegativeSpeedBetweenBeforeAndAfterOverNSignTWsWithNegativeSpeed.eps"
    ...
    res <- resampleNullPropSignTWs(
            propFunc=computePropSignTWsWithNegSpeedBtwAfterAndBeforeOverNSignTWsWithNegSpeed,
