...
processAll <- function() {
    ...
    waveEventsToPlot <- data.frame(times=waveEventsWith1DPhaseUnwrapping$times,
                                    speeds1DUnwrapping=waveEventsWith1DPhaseUnwrapping$speed)

    allSpeeds <- c(waveEventsToPlot$speeds1DUnwrapping)
