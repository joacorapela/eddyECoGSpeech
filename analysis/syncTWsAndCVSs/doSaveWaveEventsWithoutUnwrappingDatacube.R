...
processAll <- function() {
    ...
    waveEventsFilenamePattern <- "resultsTest/%s/waveEventsWithoutPhaseUnwrappingDatacubeFilteredFrom%.02fTo%.02fOrder%02dZScored%dSaveFromTime%.02fToTime%.02fDT%.02fFromElec%03dToElec%03d.%s"
