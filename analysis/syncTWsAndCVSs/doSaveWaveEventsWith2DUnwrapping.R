...
processAll <- function() {
    ...
    phasesDatacubeFilenamePattern <- "results/%s/unwrapped2DPhasesDatacubeFilteredFrom%.02fTo%.02fOrder%02dZScored%dFromTime%.02fTo%.02f.%s"
    waveEventsFilenamePattern <- "results/%s/waveEventsWith2DPhaseUnwrappingFilteredFrom%.02fTo%.02fOrder%02dSaveFromTime%.02fToTime%.02fDT%.02fFromElec%03dToElec%03d.%s"
