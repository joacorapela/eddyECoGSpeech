...
processAll <- function() {
    ...
    resultsFilenamePattern <- "results/%s/nSignWEsWithPosSpeedSig%.02frThreshold%.02fWithoutPhaseUnwrappingBetweenFilteredFrom%.02fTo%.02fOrder%02dZScored%dSaveFromTime%.02fToTime%.02fDT%.02fFromElec%03dToElec%03d.txt"
