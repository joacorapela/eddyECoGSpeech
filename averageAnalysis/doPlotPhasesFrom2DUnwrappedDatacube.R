...
processAll <- function() {
    ...
    unwrapped2dPhasesDatacubeFilenamePattern <- "results/%s/unwrapped2DPhasesDatacubeFilteredFrom%.02fTo%.02fOrder%02dZScored%dFromTime%.02fTo%.02f.%s"
    ...
    phasesDatacubeFilename <- sprintf(unwrapped2dPhasesDatacubeFilenamePattern, 
                                       sessionLabel,
