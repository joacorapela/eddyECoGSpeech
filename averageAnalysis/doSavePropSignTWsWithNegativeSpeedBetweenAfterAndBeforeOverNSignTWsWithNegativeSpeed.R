...
#      "../data/transcriptionFiles/EC2_B105/EC2_B105_transcription_final.lab"
    ...
    resultsFilenamePattern <-
     "results/%s/propSignTWsWithNegativeSpeedBetweenAfterAndBeforeOverNSignTWsWithNegativeSpeed.RData"
    ...
    for(i in 1:length(beforeLags)) {
        ...
        for(j in 1:length(afterLags)) {
            res <- computePropSignTWsWithNegSpeedBtwAfterAndBeforeOverNSignTWsWithNegSpeed(
