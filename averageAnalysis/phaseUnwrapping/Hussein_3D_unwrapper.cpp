...
{  
    ...
    char *wrapped_volume_name = "steepSurfaceObject_wrapped.dat";
    char *unwrapped_volume_name = "steepSurfaceObject_unwrapped.dat";
	int volume_width = 256;
	int volume_height = 256; 
	int volume_depth = 100;
...
printf("Showing 20 elecments of WrappedVolume\n");
int i;
for(i=0; i<20; i++) {
    printf("%f\n", WrappedVolume[i]);
}
