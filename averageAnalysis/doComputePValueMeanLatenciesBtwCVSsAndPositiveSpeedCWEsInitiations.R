...
processAll <- function() {
    ...
    resultsFilenamePattern <-
     "results/%s/pValueMeanLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.RData"
    figFilenamePattern <-
     "figures/%s/histMeanLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.eps"
