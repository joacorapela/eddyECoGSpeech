...
processAll <- function() {
    ...
    infoTerm <- getInfoCVSsTerminations(transcriptionFilename=
                                         ...
                                         ecogSampleRate=
                                          transcriptionSampleRate)
    waveEventsFromHTsFilename <- sprintf(waveEventsFromHTsFilenamePattern, sessionName, lowCutoff, highCutoff, order, saveFromTime, saveToTime, saveDTFromHTs, min(elecNumbers), max(elecNumbers), "RData")
    waveEventsWithoutPhaseUnwrappingFilename <-
sprintf(waveEventWithoutPhaseUnwrappingtsFilenamePattern, sessionName, lowCutoff, highCutoff, order, saveFromTime, saveToTime, saveDTWithoutPhaseUnwrapping, min(elecNumbers), max(elecNumbers), "RData")
