...
processAll <- function() {
    ...
    resultsFilenamePattern <-
     "results/%s/pValueVarLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.RData"
    figFilenamePattern <-
     "figures/%s/histVarLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.eps"
