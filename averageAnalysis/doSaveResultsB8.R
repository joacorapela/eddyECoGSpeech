...
processAll <- function() {
    ...
    significance <- .05
    ecogFilenamePattern <- "rData/EC2_B8/RawHTK/Wav%d%d.bin"
    erpFigFilenamePattern <- "figures/EC2_B8/erp%d%d.eps"
    resultsFilenamePattern <- "results/EC2_B8/resultsWav%d%d.RData"
    transcriptionFilename <- "matlabData/EC2_B8/EC2_B8_transcription_final.lab"
