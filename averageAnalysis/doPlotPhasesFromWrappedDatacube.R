...
processAll <- function() {
    ...
    wrappedPhasesDatacubeFilenamePattern <- "results/%s/phasesDatacubeFilteredFrom%.02fTo%.02fOrder%02dZScored%dFromTime%.02fTo%.02f.%s"
    ...
    phasesDatacubeFilename <- sprintf(wrappedPhasesDatacubeFilenamePattern, 
                                       sessionLabel,
