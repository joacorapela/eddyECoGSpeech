...
processAll <- function() {
    ...
    resultsFilenamePattern <-
     "results/%s/pValueSkewnessLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.RData"
    figFilenamePattern <-
     "figures/%s/histSkewnessLatenciesBtwCVSsAndPositiveSpeedCWEsInitiationsSign%.02f.eps"
