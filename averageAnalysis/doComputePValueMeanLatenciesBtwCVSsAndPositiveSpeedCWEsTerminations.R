...
processAll <- function() {
    ...
    resultsFilenamePattern <-
     "results/%s/pValueMeanLatenciesBtwCVSsAndPositiveSpeedCWEsTerminationsSign%.02f.RData"
    figFilenamePattern <-
     "figures/%s/histMeanLatenciesBtwCVSsAndPositiveSpeedCWEsTerminationsSign%.02f.eps"
